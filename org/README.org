...
- [[file:publish-project.org::*Initialize%20the%20publishing%20properties][Initialze the code needed to publish org-mode file]] Do this when ever the org-mode project has been changed.
